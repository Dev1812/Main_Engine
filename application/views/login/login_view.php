...
<div id="login_page" style="background-color:#FEFEFE;">
<div class="login_page__wrap">
<div class="form">

<div class="form_wrap<?php if(!empty($data['login_messages']) && $data['login_messages']['is_error'] === true) {echo ' form__error_animation';} ?>" style="width:240px;margin:0 auto;    width: 383px;
    margin: 0 auto;
...
<a href="/restore"><div style="float:right;margin-top:6px">Забыли пароль?</div></a>
...
<a href="/login"><button class="button button_gray percent_100 input_full_size_fix">Регистрация</button></a>
